...
from tranzact.harvester.harvester import Harvester
from tranzact.plotting.util import PlotInfo, parse_plot_info
from tranzact.protocols import harvester_protocol
from tranzact.protocols.farmer_protocol import FarmingInfo
from tranzact.protocols.harvester_protocol import Plot
from tranzact.protocols.protocol_message_types import ProtocolMessageTypes
from tranzact.server.outbound_message import make_msg
...
from tranzact.util.ints import uint8, uint32, uint64
...
class HarvesterAPI:
    ...
    async def new_signage_point_harvester(
        self, new_challenge: harvester_protocol.NewSignagePointHarvester, peer: WSTranzactConnection
    ):
        """
