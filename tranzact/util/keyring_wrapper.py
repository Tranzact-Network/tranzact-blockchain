...
MASTER_PASSPHRASE_SERVICE_NAME = "Tranzact Passphrase"
MASTER_PASSPHRASE_USER_NAME = "Tranzact Passphrase"
...
class KeyringWrapper:
    ...
    def confirm_migration(self) -> bool:
        ...
        if master_passphrase == DEFAULT_PASSPHRASE_IF_NO_MASTER_PASSPHRASE:
            ...
            print(
                "Would you like to set a master passphrase now? Use 'tranzact passphrase set' to change the passphrase.\n"
            )
            ...
            if response:
                ...
                print(
                    "Will skip setting a master passphrase. Use 'tranzact passphrase set' to set the master passphrase.\n"
                )
        else:
            import colorama
    ...
    def migrate_legacy_keyring_interactive(self):
        ...
        """
        from tranzact.cmds.passphrase_funcs import async_update_daemon_migration_completed_if_running
