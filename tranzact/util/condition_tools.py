...
from tranzact.types.blockchain_format.sized_bytes import bytes32, bytes48
...
def parse_sexp_to_condition(
    ...
    """
    Takes a TranzactLisp sexp and returns a ConditionWithArgs.
...
def parse_sexp_to_conditions(
    ...
    """
    Takes a TranzactLisp sexp (list) and returns the list of ConditionWithArgss
