...
from tranzact.util.config import load_config, save_config, str2bool
...
def configure(
    ...
    if testnet is not None:
        if testnet == "true" or testnet == "t":
            ...
            mainnet_port = "8655"
            mainnet_introducer = "introducer.tranzact.cash"
            mainnet_dns_introducer = "dns-introducer.tranzact.cash"
            net = "mainnet"
    ...
    if change_made:
        print("Restart any running tranzact services for changes to take effect")
