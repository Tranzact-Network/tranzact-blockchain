...
from tranzact.util.keychain import Keychain, bytes_to_mnemonic, generate_mnemonic, unlocks_keyring
...
def generate_and_print():
    ...
    print(mnemonic)
    print("Note that this key has not been added to the keychain. Run tranzact keys add")
    return mnemonic
