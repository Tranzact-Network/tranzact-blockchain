...
from tranzact.util.condition_tools import conditions_dict_for_solution
    ...
    try:
        ...
        for coinsol in trade_offer.coin_spends:
            ...
            if r:
                ...
                if "tranzact" in cc_discrepancies:
                    cc_discrepancies["tranzact"] = cc_discrepancies["tranzact"] + diff
                else:
                    cc_discrepancies["tranzact"] = diff
