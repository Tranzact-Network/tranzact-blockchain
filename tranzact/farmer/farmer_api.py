...
from tranzact.consensus.network_type import NetworkType
from tranzact.consensus.pot_iterations import calculate_iterations_quality, calculate_sp_interval_iters
from tranzact.farmer.farmer import Farmer
from tranzact.protocols import farmer_protocol, harvester_protocol
from tranzact.protocols.harvester_protocol import PoolDifficulty
...
from tranzact.util.api_decorators import api_request, peer_required
...
class FarmerAPI:
    ...
    async def new_proof_of_space(
        self, new_proof_of_space: harvester_protocol.NewProofOfSpace, peer: ws.WSTranzactConnection
    ):
        """
    ...
    @api_request
    @peer_required
    async def respond_plots(self, _: harvester_protocol.RespondPlots, peer: ws.WSTranzactConnection):
