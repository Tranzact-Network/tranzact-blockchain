"""
NOTE: This contains duplicate code from `tranzact.cmds.plots`.
After `tranzact plots create` becomes obsolete, consider removing it from there.
"""
import asyncio
import logging
...
def get_chiapos_install_info() -> Optional[Dict[str, Any]]:
    ...
    return {"display_name": "Tranzact Proof of Space", "version": chiapos_version, "installed": True}
...
def plot_tranzact(args, root_path):
