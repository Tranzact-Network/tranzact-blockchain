...
The workflows are located in [../.github/workflows/](https://github.com/Tranzact-Network/tranzact-blockchain/tree/tranzact/.github/workflows).
...
In the top tests directory, [testconfig.py](https://github.com/Tranzact-Network/tranzact-blockchain/tree/tranzact/tests/testconfig.py)
...
Set `checkout_blocks_and_plots` to `False` to omit checking out the [test-cache](https://github.com/Tranzact-Network/test-cache) repo.
