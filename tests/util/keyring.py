...
from tranzact.util.keychain import Keychain, default_keychain_service, default_keychain_user, get_private_key_user
from tranzact.util.keyring_wrapper import KeyringWrapper
...
class TempKeyring:
    ...
    def _patch_and_create_keychain(
        ...
        *,
        ...
        mock_supports_keyring_passphrase_patch = patch("tranzact.util.keychain.supports_keyring_passphrase")
