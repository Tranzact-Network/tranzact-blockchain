...
from tranzact.wallet.puzzles.p2_conditions import puzzle_for_conditions
from tranzact.wallet.puzzles import singleton_top_layer
from tranzact.pools.pool_wallet_info import PoolState
...
This test suite aims to test:
    - tranzact.pools.pool_puzzles.py
    - tranzact.wallet.puzzles.pool_member_innerpuz.clvm
    - tranzact.wallet.puzzles.pool_waiting_room_innerpuz.clvm
"""
