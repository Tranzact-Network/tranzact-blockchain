...
from tranzact.pools.pool_config import PoolWalletConfig
from tranzact.util.config import load_config, save_config, create_default_tranzact_config
...
def test_pool_config():
    ...
    create_default_tranzact_config(test_root, ["config.yaml"])
