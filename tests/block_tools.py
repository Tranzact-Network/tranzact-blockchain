...
from tranzact.plotting.util import PlotsRefreshParameter, PlotRefreshResult, PlotRefreshEvents, parse_plot_info
from tranzact.plotting.manager import PlotManager
from tranzact.server.server import ssl_context_for_server
...
from tranzact.types.blockchain_format.program import INFINITE_COST
    ...
    async def setup_keys(self):
        if self.local_keychain:
            ...
            self.keychain_proxy = await connect_to_keychain_and_validate(
                self.root_path, log, user="testing-1.8.0", service="tranzact-testing-1.8.0"
            )
    ...
    async def new_plot(
        ...
        try:
            ...
            if pool_contract_puzzle_hash is None:
                ...
                pool_address = encode_puzzle_hash(pool_contract_puzzle_hash, "trz")
