...
from tranzact.plotting.util import stream_plot_info_ph, stream_plot_info_pk, PlotRefreshResult, PlotRefreshEvents
from tranzact.plotting.manager import PlotManager
from tranzact.protocols import farmer_protocol
from tranzact.rpc.farmer_rpc_api import FarmerRpcApi
from tranzact.rpc.farmer_rpc_client import FarmerRpcClient
from tranzact.rpc.harvester_rpc_api import HarvesterRpcApi
from tranzact.rpc.harvester_rpc_client import HarvesterRpcClient
from tranzact.rpc.rpc_server import start_rpc_server
...
from tranzact.wallet.derive_keys import master_sk_to_wallet_sk, master_sk_to_pooling_authentication_sk
...
class TestRpc:
    ...
    async def test1(self, simulation):
        ...
        try:
            ...
            await client.set_reward_targets(encode_puzzle_hash(new_ph, "trz"), encode_puzzle_hash(new_ph_2, "trz"))
            ...
            await client.set_reward_targets(None, encode_puzzle_hash(new_ph_3, "trz"))
            ...
            assert config["farmer"]["trz_target_address"] == encode_puzzle_hash(new_ph, "trz")
            assert config["pool"]["trz_target_address"] == encode_puzzle_hash(new_ph_3, "trz")

            new_ph_3_encoded = encode_puzzle_hash(new_ph_3, "trz")
