...
required to run a [Timelord](https://github.com/Tranzact-Network/tranzact-blockchain/wiki/Timelords).
...
[install-timelord.sh](https://github.com/Tranzact-Network/tranzact-blockchain/blob/main/install-timelord.sh)
