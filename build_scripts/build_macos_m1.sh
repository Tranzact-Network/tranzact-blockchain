...
if [ "$NOTARIZE" ]; then
  electron-osx-sign Tranzact-darwin-arm64/Tranzact.app --platform=darwin \
...
mv Tranzact-darwin-arm64 ../build_scripts/dist/
cd ../build_scripts || exit

DMG_NAME="Tranzact-$TRANZACT_INSTALLER_VERSION-arm64.dmg"
echo "Create $DMG_NAME"
mkdir final_installer
electron-installer-dmg dist/Tranzact-darwin-arm64/Tranzact.app Tranzact-$TRANZACT_INSTALLER_VERSION-arm64 \
